      ...
      <div class="lg:grid lg:grid-cols-2 lg:items-start lg:gap-x-8">
        ...
        <div class="mt-10 px-4 sm:mt-16 sm:px-0 lg:mt-0">
          ...
          <div class="mt-10 flex items-center gap-6">
            <Button class="text-base h-12 px-16"><ShoppingCart class="mr-4" /> Add to Cart</Button>
          ...
          <div class="mt-6">
            <div class="space-y-6 text-base text-gray-700">
              ...
              <p>
                Lorem, ipsum dolor sit amet consectetur adipisicing elit. Excepturi labore doloribus
                alias ad placeat, quis aperiam enim temporibus, deserunt vitae quibusdam eos
                laudantium commodi iure. Tempore reprehenderit dolore facilis officiis dolorem,
                minima saepe quos, eligendi debitis impedit unde! Illum, id!
              </p>
              <p>
                ...
                quam nemo numquam! Porro quis hic ab soluta sit, dolores perspiciatis maiores iure?
                Fugit, rem dicta.
              </p>
            </div>
          </div>
